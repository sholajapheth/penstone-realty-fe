    ...
    <div className="flex justify-center items-center flex-col">
      <div className="max-w-[1200px]">
        <div className="lg:px-[5em]">
          <div className="bg-[#F5FCFF80] px-[1em] py-[2em] ">
            <p className="text-secondary lg:leading-[120%] text-[30px] lg:text-[70px] font-semibold w-full lg:w-[80%]">
              How to attract buyers and close deals
            </p>
          </div>
          <div className="px-[1em] pt-[2em] pb-[1.5em]">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex flex-col gap-4 mt-4">
                    ...
                    <p className="w-full text-[18px] leading-[2em]">
                      ...
                      services industry, with plenty of hands-on experience to
                      back it up.
                    </p>
                  </div>
                </div>
