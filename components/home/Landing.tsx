...
const Landing = () => {
  ...
  return (
    <div className="px-[1em] pt-[36px] pb-[50px] lg:pt-[130px] bg-[url('/img/home-landing-bg.png')] bg-no-repeat bg-cover lg:bg-position-y-[-100px] lg:bg-position-x-[50px] flex flex-col items-center justify-center">
      <div
      ...
      <div className="lg:hidden mt-[30px] bg-white rounded-[10px] w-[90%]flex justify-between flex-col px-[14px]">
        ...
        <div className="w-full bg-white  py-[14px]">
            ...
            <div className="flex items-center justify-between ">
              <input type="search" placeholder="Search location" className='outline-none ' />
              <button
