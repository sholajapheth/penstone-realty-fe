          ...
          <div className="flex flex-col gap-[40px] w-[60%] py-[24px]">
            ...
            <div>
              ...
              <p className="text-black">
                ...
                California. With a deep understanding of the local market and a
                commitment to providing exceptional service, she is the go-to
                choice for buyers and sellers looking to navigate the California
